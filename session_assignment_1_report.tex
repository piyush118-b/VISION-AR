...
\hypersetup{
    ...
    linkcolor=blue,
    urlcolor=cyan,
    pdftitle={Session Assignment I - VisionAR Studio Report},
...
\lhead{Session Assignment - I: VisionAR Studio}
\rfoot{Page \thepage}
...
\begin{titlepage}
    ...
    {\fontsize{20}{25}\selectfont \textbf{VISIONAR: TOUCHLESS AIR CANVAS\\[0.2cm]\& 3D VIRTUAL INTERACTION LABORATORY}\par}
    \vspace{0.3cm}
    {\fontsize{12}{15}\selectfont \textit{Computer Graphics \& Multimedia Systems --- Session Assignment I Report}\par}
    \vspace{0.4cm}
    ...
    \vfill
    {\large \textbf{Date of Submission:} August 27, 2026}
\end{titlepage}
